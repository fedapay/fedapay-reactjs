...
var FedaCheckoutButton = /** @class */ (function (_super) {
    ...
    FedaCheckoutButton.prototype.render = function () {
        var _this = this;
        return (React.createElement("button", __assign({ ref: function (el) { return _this.buttonRef = el; } }, this.props), "Click"));
    };
...
exports.FedaPayCheckoutComponent = FedaPayCheckoutComponent;
